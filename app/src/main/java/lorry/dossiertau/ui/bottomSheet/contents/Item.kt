...
@Composable
fun MainActivity.TpdbButton(item: TauItem){Button(colors=ButtonDefaults.outlinedButtonColors(containerColor=Color.Transparent,contentColor=Color.DarkGray,disabledContainerColor=Color.Gray),shape=RoundedCornerShape(8.dp),border=BorderStroke(1.dp,TauColors.Tertiary),onClick={startActivity(Intent(this,TpdbTestActivity::class.java).putExtra(TpdbTestActivity.EXTRA_FILENAME,item.name.value))}){Text("Tester TPDB")}}
